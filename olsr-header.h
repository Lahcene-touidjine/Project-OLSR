...
#include <vector>
#include "ns3/mobility-module.h"// nzido includ hadi 
namespace ns3 {
namespace olsr {
...
//modified code 
// ajouter la fonction Setx1 et Getx1 qui recuprer la valeur x
double x1;
void Setx1 (double x)
    {
      this->x1=x;
...
//modified code 
// ajouter la fonction Sety1 et Gety1 qui recuprer la valeur y
double y1;
void Sety1 (double y)
    {
      this->y1=y;
...
//modified code 
// ajouter la fonction SetDist et GetDist qui recuprer la valeur d
mutable double Dist;
...
// y1;
     ...
     * \returns the expected size of the header.
     */
    uint64_t GetSerializedSize (void) const;
    /**
     * This method is used by Packet::AddHeader to
     * store a header into the byte buffer of a packet.
     *
     ...
     * \returns the number of bytes read.
     */
    uint64_t Deserialize (Buffer::Iterator start, uint64_t messageSize);
  };
